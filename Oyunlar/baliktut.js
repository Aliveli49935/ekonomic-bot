...
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
   if (crime !== null && timeout - (Date.now() - crime) > 0) {
     ...
     if(para < 6000) return message.channel.send(new Discord.MessageEmbed()
                      .setColor("RED")
                      .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
                                                .setDescription(`Balık tutmak için balıkçı dayıdan olta kiralamalısın! Gereken Para: 5000 💸`))
        const result = [
          "WINWIN",
          "LOOSELOOSE"
        ] 
...
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
 ...
 const sentences2 = ["Çipura tuttun","Hamsi tuttun","Kolyoz tuttun","İsavrit tuttun"]
     var sentence2 = sentences2[Math.floor(Math.random() * sentences2.length)]
         var kazandın = rastgeleMiktar(5000,6000)
